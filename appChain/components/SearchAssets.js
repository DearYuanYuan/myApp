/*
    资产搜索
        点击搜索会在所有的资产中搜索匹配的资产（与资产内容匹配）
        未填写任何搜索关键字，则会显示所有的资产
        为搜索到相关资产，会有信息提示。
*/
...
export default class SearchAssets extends React.Component {
    ...
    */
    assetsLoad(pageNum,pageSize){
        ...
        formData.append('asset_search',this.state.searchContent) //搜索关键字
    ...
    */
    searchGo(){
        this.setState({
            loadMore:true, //现在加载loading
            assetsListData:[], //初始化搜索资产列表
            errorMsg:'',//错误信息提示
        })
        //搜索请求
